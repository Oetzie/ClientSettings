...
$_lang['clientsettings.label_setting_tinymce_config_desc']      = 'The TinyMCE config for the TinyMCE editor.';
$_lang['clientsettings.label_setting_clientgrid_config']        = 'Grid config';
$_lang['clientsettings.label_setting_clientgrid_config_desc']   = 'The grid config for the grid.';
...
$_lang['clientsettings.xtype_richtext']                         = 'Texteditor';
