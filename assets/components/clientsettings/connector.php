<?php
	...
	$corePath = $modx->getOption('clientsettings.core_path', null, $modx->getOption('core_path').'components/clientsettings/');
	
	require_once $corePath.'model/clientsettings/clientsettings.class.php';
	
	$modx->clientsettings = new ClientSettings($modx);
	
	$modx->lexicon->load('clientsettings:default');
	
	$path = $modx->getOption('processorsPath', $modx->clientsettings->config, $corePath.'processors/');
